    ...
    <section class="hero-gradient bg-pattern min-h-screen flex items-center relative overflow-hidden">
        ...
        <div class="container mx-auto px-8 grid lg:grid-cols-2 gap-16 items-center relative z-10">
            ...
            <div class="text-white animate-fade-in-up ml-8">
                ...
                <button
                    class="bg-blue-400 text-white px-8 py-4 rounded-md font-semibold text-lg hover:bg-blue-500 transition-all duration-300 transform hover:scale-105 shadow-lg">
                    LEARN MORE
                </button>
            </div>
            ...
            <div class="relative animate-slide-in-right">
                <div class="relative">
                    ...
                    <div
                        class="absolute -inset-4 bg-gradient-to-r from-blue-400 to-blue-500 rounded-full blur-xl opacity-20 animate-pulse">
                    </div>

                    <!-- Student Image Container -->
                    <div class="relative bg-white bg-opacity-10 rounded-full p-12 backdrop-blur-sm">
                        <img src="{{ asset('images/student.png') }}" alt="Happy Student" class="w-96 max-w-full mx-auto"
